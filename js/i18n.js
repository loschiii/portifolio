...
(function () {
    ...
    const translations = {
        en: {
            ...
            "meta.desc": "Software developer and Computer Science student at PUC-Rio. I build software end to end — from personal projects to AI products delivered to a real client.",
            "nav.home": "Home",
            "nav.about": "About",
            ...
            "hero.intro": "I'm a <span class=\"hl\">Software Engineer</span> passionate about <span class=\"hl\">AI</span>, a Computer Science student at PUC-Rio and a full merit scholar of the Behring Foundation. I turn ideas into working software — from personal projects to AI products delivered to a real client.",
            ...
            "about.p1": "My name is Pedro Loschi Giovannini. I'm <span class=\"hl\">20 years old</span>, based in Rio de Janeiro, and I've been writing software for as long as it takes to turn curiosity into something that runs.",
            "about.p2": "I have <span class=\"hl\">1+ year of experience</span> as a <span class=\"hl\">software developer</span>, building web applications end to end — from the interface to the backend, the database and the delivery.",
            "about.p3": "I'm pursuing a <span class=\"hl\">Computer Science degree at PUC-Rio</span> as a <span class=\"hl\">full merit scholar</span> of the Behring Foundation, after placing 1st in the program's entrance exam. I care about products that balance <span class=\"hl\">performance</span>, <span class=\"hl\">usability</span> and <span class=\"hl\">reliability</span>.",
            "about.p4": "My main stack is <span class=\"hl\">Python/Django</span> and <span class=\"hl\">JavaScript/TypeScript with React</span>, plus <span class=\"hl\">REST APIs</span>, <span class=\"hl\">ORMs</span> and relational databases. I also have academic experience with <span class=\"hl\">Java</span>, <span class=\"hl\">C</span> and <span class=\"hl\">OOP</span>.",
            "about.p5": "I have hands-on experience <span class=\"hl\">building MVPs</span>, integrating <span class=\"hl\">AI features</span> and <span class=\"hl\">LLMs</span> into real applications, and presenting the results at <span class=\"hl\">Pitch Days</span> and <span class=\"hl\">Demo Days</span>.",
            "about.p6": "Fun fact: I also teach. As a <span class=\"hl\">Python teaching assistant</span> at PUC-Rio, explaining logic to beginners turned out to be the best debugger for my own thinking.",
            "about.stat1suffix": "st",
            "about.stat1": "place in PUC-Rio's CS entrance exam",
            "about.stat2": "merit scholarship — Behring Foundation",
            "about.stat3": "AI products shipped end to end",
            "about.stat4": "year shipping real-world products",
            "projects.kicker": "Portfolio",
            "projects.title": "From idea to working software",
            "projects.intro": "A mix of what I've built — from personal projects to AI-powered applications delivered to a real client. Each one taken from the first idea to working software.",
            "projects.gallery": "View gallery",
            "projects.oraculo.tagline": "Intelligent document verification",
            "projects.oraculo.desc": "Over a three-month cycle, my team and I went from user research to a working MVP: a web application that uses AI to check documents against reference standards and automatically flag inconsistencies, making document review faster and more structured.",
        ...
        pt: {
            ...
            "meta.desc": "Desenvolvedor de software e estudante de Ciência da Computação na PUC-Rio. Construo software de ponta a ponta — de projetos pessoais a produtos com IA entregues a um cliente real.",
            "nav.home": "Início",
            "nav.about": "Sobre",
            ...
            "hero.intro": "Sou <span class=\"hl\">Engenheiro de Software</span> apaixonado por <span class=\"hl\">IA</span>, estudante de Ciência da Computação na PUC-Rio e bolsista integral por mérito da Fundação Behring. Transformo ideias em software funcionando — de projetos pessoais a produtos com IA entregues a um cliente real.",
            ...
            "about.p1": "Meu nome é Pedro Loschi Giovannini. Tenho <span class=\"hl\">20 anos</span>, moro no Rio de Janeiro e escrevo software desde que descobri como transformar curiosidade em algo que funciona.",
            "about.p2": "Tenho <span class=\"hl\">mais de 1 ano de experiência</span> como <span class=\"hl\">desenvolvedor de software</span>, construindo aplicações web de ponta a ponta — da interface ao backend, ao banco de dados e à entrega.",
            "about.p3": "Curso <span class=\"hl\">Ciência da Computação na PUC-Rio</span> como <span class=\"hl\">bolsista integral por mérito</span> da Fundação Behring, depois de passar em 1º lugar no vestibular do curso. Me importo com produtos que equilibram <span class=\"hl\">performance</span>, <span class=\"hl\">usabilidade</span> e <span class=\"hl\">confiabilidade</span>.",
            "about.p4": "Minha stack principal é <span class=\"hl\">Python/Django</span> e <span class=\"hl\">JavaScript/TypeScript com React</span>, além de <span class=\"hl\">APIs REST</span>, <span class=\"hl\">ORMs</span> e bancos relacionais. Também tenho experiência acadêmica com <span class=\"hl\">Java</span>, <span class=\"hl\">C</span> e <span class=\"hl\">POO</span>.",
            "about.p5": "Tenho experiência prática na <span class=\"hl\">construção de MVPs</span>, integrando <span class=\"hl\">recursos de IA</span> e <span class=\"hl\">LLMs</span> em aplicações reais, e na apresentação dos resultados em <span class=\"hl\">Pitch Days</span> e <span class=\"hl\">Demo Days</span>.",
            "about.p6": "Curiosidade: eu também ensino. Como <span class=\"hl\">monitor de Python</span> na PUC-Rio, explicar lógica para iniciantes virou o melhor depurador do meu próprio raciocínio.",
            "about.stat1suffix": "º",
            "about.stat1": "lugar no vestibular de CC da PUC-Rio",
            "about.stat2": "bolsa por mérito — Fundação Behring",
            "about.stat3": "produtos com IA entregues de ponta a ponta",
            "about.stat4": "ano entregando produtos reais",
            "projects.kicker": "Portfólio",
            "projects.title": "Da ideia ao software funcionando",
            "projects.intro": "Uma mistura do que já construí — de projetos pessoais a aplicações com IA entregues a um cliente real. Cada uma levada da primeira ideia ao software funcionando.",
            "projects.gallery": "Ver galeria",
            "projects.oraculo.tagline": "Verificação inteligente de documentos",
            "projects.oraculo.desc": "Em um ciclo de três meses, eu e minha equipe fomos da pesquisa com usuários a um MVP funcional: uma aplicação web que usa IA para conferir documentos contra normas de referência e apontar inconsistências automaticamente, tornando a revisão documental mais ágil e estruturada.",
