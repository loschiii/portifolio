...
(function () {
    ...
    const translations = {
        en: {
            ...
            "about.p2": "I like to work end to end: from problem discovery and requirements to architecture, implementation, testing and delivery. I've been putting that into practice for over a year at Instituto ECOA (PUC-Rio / Petrobras Ignição program) and in my own projects — including this very site, built from scratch with no frameworks. I also support new programmers as a Python teaching assistant at PUC-Rio.",
            ...
            "projects.intro": "A mix of what I've built: AI products designed, validated and delivered to a real client through the Ignição program (Instituto ECOA PUC-Rio), and personal projects — like this very site.",
        ...
        pt: {
            ...
            "about.p2": "Gosto de atuar de ponta a ponta: da descoberta do problema e dos requisitos à arquitetura, implementação, testes e entrega. Venho praticando isso há mais de um ano no Instituto ECOA (programa Ignição PUC-Rio / Petrobras) e nos meus próprios projetos — inclusive este site, feito do zero e sem frameworks. Também apoio novos programadores como monitor de Python na PUC-Rio.",
            ...
            "projects.intro": "Uma amostra do que construí: produtos com IA concebidos, validados e entregues a um cliente real pelo programa Ignição (Instituto ECOA PUC-Rio), e projetos pessoais — como este próprio site.",
